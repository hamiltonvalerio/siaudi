    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'sigla_auditoria',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o EspecieAuditoria '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("EspecieAuditoria/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
