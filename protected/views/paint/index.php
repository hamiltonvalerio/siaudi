    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'numero_sequencia',
            ...
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Relatorioitem '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("Relatorioitem/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
