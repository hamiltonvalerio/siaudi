  ...
  $cs->registerScriptFile($baseUrl.'/js/Capitulo.js');
    ...
    <fieldset class="visivel">
        ...
        <div style="height:5px;"></div>
                <div class='row'>
                    <div class='label'><?php echo $form->label($model, 'numero_capitulo2'); ?></div>
                    <div class='field'>
    ...
    <div class="rowButtonsN1">
        ...
        <?php echo CHtml::link(Yii::t('app', 'Voltar para Relatório'), $this->createUrl('relatorio/'), array('class' => 'imitacaoBotao')); ?>
    </div>                             
    ...
    <div class="rowButtonsN1">
        <?php echo CHtml::link(Yii::t('app', 'Create'), $this->createUrl('Capitulo/admin'), array('class' => 'imitacaoBotao')); ?>
    </div>
