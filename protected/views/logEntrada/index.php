    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'id',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o LogEntrada '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("LogEntrada/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
