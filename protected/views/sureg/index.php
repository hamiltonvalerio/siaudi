    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'subordinante_fk',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover a Unidade Regional '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("UnidadeAdministrativa/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
