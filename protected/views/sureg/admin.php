...
<div class='label'><?php echo $form->labelEx($model,'nome'); ?></div>
                <div class='field'><?php echo $form->textField($model, 'nome', array('maxlength' => 80,'size' => 35)); ?></div>
 </div><!-- row -->
                                                <div class='row'>
<div class='label'><?php echo $form->labelEx($model,'sigla'); ?></div>
                <div class='field'><?php echo $form->textField($model, 'sigla', array('maxlength' => 20,'size' => 20)); ?></div>
 </div><!-- row -->
                                                <div class='row'>
<div class='label'><?php echo $form->labelEx($model,'uf_fk'); ?></div>
                <div class='field'><?php echo $form->textField($model, 'uf_fk', array('maxlength' => 2,'size' => 2)); ?></div>
 </div><!-- row -->
                                                <div class='row'>
<div class='label'><?php echo $form->labelEx($model,'subordinante_fk'); ?></div>
                <div class='field'><?php echo $form->textField($model, 'subordinante_fk'); ?></div>
 </div><!-- row -->
...
<?php echo CHtml::link(Yii::t('app', 'Cancel'),$this->createUrl('UnidadeAdministrativa/index'), array('class' => 'imitacaoBotao')); ?>
    </div>
<?php $this->endWidget(); ?>
</div><!-- form -->