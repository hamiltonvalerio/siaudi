...
<div class="formulario" Style="width: 70%;">
    ...
    <fieldset class="visivel">
        ...
        <div class='row'>
            ...
            <div class='field'>
                ...
                if ($perfil == "siaudi_cliente") {
                    $model_auditor_fk = array("" => "Selecione") + CHtml::listData(Usuario::ObtemUsuariosSubordinados(), 'id', 'nome_usuario');
                } else {
                    $model_auditor_fk = array("" => "Selecione") + CHtml::listData(Usuario::model()->findAll(), 'id', 'nome_usuario');
                }
                $form->widget('ext.EchMultiSelect.EchMultiSelect', array(
                    'model' => $model,
                    'dropDownAttribute' => 'id_login',
                    'data' => $model_auditor_fk,
        ...
        <div class='row'>
            ...
            <div class='field'>
                <?php
                if ($perfil == "siaudi_cliente") {
                    $relatorio_sureg_dados = array("" => "Selecione") + CHtml::listData(Usuario::ObtemUnidadesAdministrativasSubordinadas(), 'id', 'sigla');
                } else {
    ...
    <div class="rowButtonsN1">
        <?php echo CHtml::link(Yii::t('app', 'Create'), $this->createUrl('RelatorioAcessoItem/admin'), array('class' => 'imitacaoBotao')); ?>
    </div>
