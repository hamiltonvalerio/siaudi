    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'descricao_mitigacao',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o RiscoPos '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("RiscoPos/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
