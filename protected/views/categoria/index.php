    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'descricao_categoria',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Categoria '+$(this).parent().parent().children(':first-child').text()+'?'",
            	'updateButtonUrl' => 'Yii::app()->createUrl("Categoria/admin/".$data->id."?".$_SERVER["QUERY_STRING"])',
             )
            )
          )
        );
