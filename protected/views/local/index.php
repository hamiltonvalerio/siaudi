    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'nome_local',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Local '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("Local/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
