...
<div class='row'>
<div class='label'><?php echo $form->label($model, 'nome_local'); ?></div>
            <div class='field'>
<?php echo $form->textField($model, 'nome_local', array('maxlength' => 200,'size' => 35)); ?>
</div>
</div>                
    ...
    <div class="rowButtonsN1">
        <?php echo CHtml::link(Yii::t('app', 'Create'),$this->createUrl('Local/admin'), array('class' => 'imitacaoBotao')); ?>
    </div>
