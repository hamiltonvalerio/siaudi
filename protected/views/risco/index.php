    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'exercicio',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover a tabela de risco '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("Risco/admin",  array("exercicio" => $_GET["Risco"]["exercicio"]) )',
             )
            )
          )
        );
