...
<?php if ( !is_null($dados) ): ?><div class="tabelaListagemItensWrapper">
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'data_inclusao',
		'arquivo',
		'numero_tamanho_arquivo',
            array(
                'class' => 'application.components.MyButtonColumn',
                'deleteConfirmation' => "js:'Deseja remover o Anexo '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("Anexo/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
