    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'nome_interno',                
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Perfil '+$(this).parent().parent().children(':first-child').text()+'?'",
            	'updateButtonUrl' => 'Yii::app()->createUrl("Perfil/admin/".$data->id."?".$_SERVER["QUERY_STRING"])',
             )
            )
          )
        );
