    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'nome_objeto',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Objeto '+$(this).parent().parent().children(':first-child').text()+'?'",
            	'updateButtonUrl' => 'Yii::app()->createUrl("Objeto/admin/".$data->id."?".$_SERVER["QUERY_STRING"])',
             )
            )
          )
        );
