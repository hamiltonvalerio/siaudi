...
<div class="formulario" Style="width: 70%;">
    ...
    <fieldset class="visivel">
        ...
        <div class='row'>
            <div class='label'><?php echo $form->label($model, 'descricao_questao'); ?></div>
            <div class='field'>
                <?php echo $form->textField($model, 'descricao_questao', array('maxlength' => 500, 'size' => 35)); ?>
            </div>
        </div>                                
    ...
    <div class="rowButtonsN1">
        <?php echo CHtml::link(Yii::t('app', 'Create'), $this->createUrl('AvaliacaoCriterio/admin'), array('class' => 'imitacaoBotao')); ?>
    </div>
