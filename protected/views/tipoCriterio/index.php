    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'nome_criterio',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o TipoCriterio '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("TipoCriterio/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
