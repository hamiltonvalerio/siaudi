...
<div class='label'><?php echo $form->labelEx($model,'nome_criterio'); ?></div>
                <div class='field'><?php echo $form->textField($model, 'nome_criterio', array('maxlength' => 100,'size' => 35, 'style' => 'width: 500px')); ?></div>
 </div><!-- row -->
...
<?php echo CHtml::link(Yii::t('app', 'Cancel'),$this->createUrl('TipoCriterio/index'), array('class' => 'imitacaoBotao')); ?>
    </div>
<?php $this->endWidget(); ?>
</div><!-- form -->