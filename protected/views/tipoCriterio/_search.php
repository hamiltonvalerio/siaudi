...
<div class='label'><?php echo $form->label($model, 'nome_criterio'); ?></div>
            <div class='field'>
<?php echo $form->textField($model, 'nome_criterio', array('maxlength' => 100,'size' => 35, 'style' => 'width: 500px')); ?>
</div>
</div>                
    ...
    <div class="rowButtonsN1">
        <?php echo CHtml::link(Yii::t('app', 'Create'),$this->createUrl('TipoCriterio/admin'), array('class' => 'imitacaoBotao')); ?>
    </div>
