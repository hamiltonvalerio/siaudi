...
<?php if ( !is_null($dados) ): ?><div class="tabelaListagemItensWrapper">
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		array(
				'name'=>'perfil_fk',
				'value'=>'GxHtml::valueEx($data->cargoFk)',
				'filter'=>GxHtml::listDataEx(Cargo::model()->findAllAttributes(null, true)),
				),
		array(
				'name'=>'nucleo_fk',
            ...
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Usuário '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("Usuario/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
