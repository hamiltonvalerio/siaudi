    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'nome_cargo',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Cargo '+$(this).parent().parent().children(':first-child').text()+'?'",
            	'updateButtonUrl' => 'Yii::app()->createUrl("Cargo/admin/".$data->id."?".$_SERVER["QUERY_STRING"])',
             )
            )
          )
        );
