            ...
            $this->widget('zii.widgets.grid.CGridView', array(
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'deleteConfirmation' => "js:'Deseja remover o TipoAcao '+$(this).parent().parent().children(':first-child').text()+'?'",
                        'updateButtonUrl' => 'Yii::app()->createUrl("TipoAcao/admin",  array("id" => $data->id) )',
                    )
                )
                    )
            );
