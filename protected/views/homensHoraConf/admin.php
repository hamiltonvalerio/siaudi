...
<div class="formulario" Style="width: 70%;">
    ...
    <fieldset class="visivel">
        ...
        <div class='row'>
            <div class='label'><?php echo $form->labelEx($model, 'descricao_act'); ?></div>
            <div class='field'><?php echo $form->textField($model, 'descricao_act', array('maxlength' => 1000, 'size' => 35)); ?></div>
        </div><!-- row -->
    ...
    <div class="rowButtonsN1">
        ...
        <?php echo CHtml::link(Yii::t('app', 'Cancel'), $this->createUrl('HomensHoraConf/index'), array('class' => 'imitacaoBotao')); ?>
    </div>
    <?php $this->endWidget(); ?>
</div><!-- form -->