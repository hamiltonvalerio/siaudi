    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
		...
		'descricao_act',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o HomensHoraConf '+$(this).parent().parent().children(':first-child').text()+'?'",
                'updateButtonUrl' => 'Yii::app()->createUrl("HomensHoraConf/admin",  array("id" => $data->id) )',
             )
            )
          )
        );
