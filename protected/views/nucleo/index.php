...
<?php if ( !is_null($dados) ): ?><div class="tabelaListagemItensWrapper">
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o Nucleo '+$(this).parent().parent().children(':first-child').text()+'?'",
            	'updateButtonUrl' => 'Yii::app()->createUrl("Nucleo/admin/".$data->id."?".$_SERVER["QUERY_STRING"])',
             )
            )
          )
        );
