...
<div class="formulario" Style="width: 70%;">
    ...
    <fieldset class="visivel">
        ...
        <div class='row'>
            ...
            <div class='field'>
                <?php
                Usuario::model()->scenario = "search";
                $plan_usuario_dados = array(null => "Selecione") + CHtml::listData(Usuario::model()->findAll(array('order' => 'nome_usuario')), 'nome_usuario', 'nome_usuario');
        ...
        <div class='row'>
            <div class='label'><?php echo $form->label($model, 'funcao_fk'); ?></div>
        ...
        <div class='row'>
            <div class='label'><?php echo $form->label($model, 'cargo_fk'); ?></div>
        ...
        <div class='row'>
            ...
            <div class='field'>
                <?php echo $form->dropDownList($model, 'perfil_fk', GxHtml::listDataEx(Perfil::model()->findAllAttributes(null, true, array('order' => 'nome_perfil'))), array('prompt' => Yii::t('app', ' Selecione'), 'style' => 'width:250px')); ?>
            </div>
        </div>                                
        <div class='row'>
            <div class='label'><?php echo $form->label($model, 'nucleo_fk'); ?></div>
            <div class='field'>
                <?php echo $form->dropDownList($model, 'nucleo_fk', GxHtml::listDataEx(Nucleo::model()->findAllAttributes(null, true, array('order' => 'nome_nucleo'))), array('prompt' => Yii::t('app', ' Selecione'), 'style' => 'width:250px')); ?>
            </div>
        </div>               
        <div class='row'>
