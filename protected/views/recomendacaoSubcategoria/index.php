...
<?php if ( !is_null($dados) ): ?><div class="tabelaListagemItensWrapper">
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
            'id' => 'recomendacao-subcategoria-grid',
            'dataProvider' => $dados,
    		'enableSorting' => false,
		...
		'nome_subcategoria',
            array(
                ...
                'deleteConfirmation' => "js:'Deseja remover o RecomendacaoSubcategoria '+$(this).parent().parent().children(':first-child').text()+'?'",
            	'updateButtonUrl' => 'Yii::app()->createUrl("RecomendacaoSubcategoria/admin/".$data->id."?".$_SERVER["QUERY_STRING"])',
             )
            )
          )
        );
