...
<div class="formulario" Style="width: 70%;">
    ...
    <fieldset class="visivel">
        ...
        <div class='row'>
            ...
            <div class='field'>
                <?php
                $acao_sureg_dados = array("Todas" => "Todas") + CHtml::listData(UnidadeAdministrativa::model()->findAll(array("condition" => '"sureg" = true', 'order' => 'sigla')), 'id', 'sigla');
        ...
        <div class="row" >
            ...
            <div class="field">
                <?php
                echo $form->checkBox($model, 'bolInseriDescRecomendacao', array('value' => '1', 'uncheckValue' => '0')) . " ";
                echo $form->label($model, 'bolInseriDescRecomendacao');
                ?>
            </div>
        </div>
