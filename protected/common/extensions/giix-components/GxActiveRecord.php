...
abstract class GxActiveRecord extends CActiveRecord {
    ...
    public $usuario_inclusao_fk;
    public $data_inclusao;
    public $usuario_exclusao_fk;
    ...
    /*
     * Quando um atributo vier com valor vazio, não inclui-lo na gravação
     * deixando para o BD tratar o valor do atributo
     */
