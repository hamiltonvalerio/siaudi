...
return array (
  ...
  'Delete' => 'Excluir',
  'Displaying {start}-{end} of {count} result(s).' => 'O sistema encontrou {count} ocorrência(s) com os parâmetros informados',// {start}-{end} de {count} resultado(s).',
  'Either "name" or "value" must be specified for CDataColumn.' => '"name" ou "value" deve ser especificado para CDataColumn.',
  'Home' => 'Página inicial',
  'No results found.' => 'Nenhum registro encontrado',
