...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		//monthNamesShort: ['Janeiro','Fevereiro','Março','Abril','Maio','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro'], // Names of months for drop-down and formatting
		monthNamesShort: ['Jan', 'Fev', 'Mar', 'Abr', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dez'], // For formatting
		dayNames: ['Domingo', 'Segunda', 'Terçaa', 'Quarta', 'Quinta', 'Sexta', 'Sábado'], // For formatting
