<?php
	...
	$cfg['create'] 		= no; 													// allow to create directory: 'true' or 'false'
	...
	$cfg['furl'] 		= false;														// default: true; if set to true, full url incl. domain will be added to image src
	...
	// use static image libraries	
        ...
        $url_aplicacao = explode("/", $_SERVER['SCRIPT_NAME']); 
        $url_aplicacao = $url_aplicacao[1] . "/js/tiny_mce/plugins/ibrowser";        
	...
	$cfg['ilibs_dir'] 	   = array( $url_aplicacao.'/pictures/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
