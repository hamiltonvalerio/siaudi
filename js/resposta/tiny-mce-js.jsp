...
<script type="text/javascript" src='<?php 
            //$model_recomendacao->id ocorre no follow up
          if($model->id || $model_recomendacao->id){ echo "../";}?>../js/tiny_mce/jquery.tinymce.js'></script>
...
<script>
	...
	$().ready(function() {
		...
		$('textarea.tinymce_advanced').tinymce({
			// Location of TinyMCE script
			script_url : '<?php if($model->id || $model_recomendacao->id){ echo "../";}?>../js/tiny_mce/tiny_mce.js',
			...
			// General options
			theme : "advanced",
			plugins : "autolink,lists,pagebreak,style,layer,table,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,advlist",
			...
			theme_advanced_buttons4 : "cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,pagebreak,|,code",
